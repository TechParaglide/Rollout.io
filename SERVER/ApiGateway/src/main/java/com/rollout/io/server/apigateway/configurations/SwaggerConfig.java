    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Rollout.io")
                        .version("1.0.0")
                        .description("<h3> Secure API Gateway Authorization</h3>" +
                                "<p>To access these APIs, you need a valid <b>Firebase Identity Token</b>.</p>" +
                                "<h4>How to get a Token:</h4>" +
                                "<ul>" +
                                "  <li><b>Via Postman:</b> Call the <code>/login</code> endpoint or use Firebase Auth SDK to get the <code>idToken</code>.</li>" +
                                "  <li><b>Via Developer:</b> Request the Backend Team for a 'Test Environment Token'.</li>" +
                                "</ul>" +
                                "<p>Click the <b>Authorize</b> button and paste the token below.</p>")
                        .contact(new Contact()
